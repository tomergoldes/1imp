        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 1.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem", alignItems: "flex-start" }}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              ...
              <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "1.5rem", color: "#100030", marginBottom: "0.5rem" }}>Basic</h3>
              ...
              <Link href="/create" style={{ display: "block", textAlign: "center", width: "100%", padding: "1rem", background: "rgba(16,0,48,0.05)", color: "#100030", borderRadius: 12, fontWeight: 600, textDecoration: "none", transition: "background 150ms", marginBottom: "2rem" }}>
                Generate Video
              </Link>
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "0.9375rem", color: "#444466" }}>
                    <Check size={18} color="#E8355A" /> {feature}
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
              ...
              <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "1.5rem", color: "white", marginBottom: "0.5rem" }}>Pro</h3>
              <div style={{ display: "flex", alignItems: "baseline", gap: "0.25rem", marginBottom: "1rem" }}>
              ...
              <Link href="/create" style={{ display: "block", textAlign: "center", width: "100%", padding: "1rem", background: "#E8355A", color: "white", borderRadius: 12, fontWeight: 600, textDecoration: "none", boxShadow: "0 4px 16px rgba(232,53,90,0.3)", marginBottom: "2rem" }}>
                Upgrade to Pro
              </Link>
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: "0.25rem", marginBottom: "1rem" }}>
                ...
                <span style={{ fontSize: "1rem", color: "#888" }}>once</span>
              </div>
              <p style={{ fontSize: "0.9375rem", color: "#555570", marginBottom: "2rem", lineHeight: 1.5 }}>
